...
//     Configure the cell...
    ...
    if (!cell) {
        cell = [[CompanyTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:@"cell"] ;
    }
    
    CompanyObject * company = self.datasoure[indexPath.row];
    cell.companyObject = company;
