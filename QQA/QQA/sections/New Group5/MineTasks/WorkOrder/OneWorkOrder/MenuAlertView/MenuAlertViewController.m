...
-(UIView *)bottomView {
    if (!_bottomView) {
        ...
        CGFloat h = 50 ;
        CGFloat x = 0;
        CGFloat y = self.showView.frame.size.height - h + 100;
...
-(CenterView *)centerView {
    if (!_centerView) {
        ...
        CGFloat w = CGRectGetWidth(self.showView.frame);
        CGFloat h = CGRectGetHeight(self.showView.frame)-CGRectGetHeight(self.titleLabel.frame)-CGRectGetHeight(self.bottomView.frame) + 100;
        CGFloat x = 0;
