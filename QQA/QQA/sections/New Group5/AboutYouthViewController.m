...
-(void)setAppCoverImageName:(NSString *)imageName title:(NSString *)title{
    ...
    UILabel * statementLable = [[UILabel alloc] initWithFrame:CGRectMake( 20 , iphoneHeight  - 130, iphoneWidth - 40, 30)];
    ...
    UILabel * statementLable2 = [[UILabel alloc] initWithFrame:CGRectMake( 20 , iphoneHeight   - 100, iphoneWidth - 40, 30)];
